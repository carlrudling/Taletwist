...
const VotesIcon: React.FC<VotesIconProps> = ({ width = '100%', height = '100%', color = 'fill-quiz-green' }) => (
 <svg width={width} height={height} xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 512 512">
