...
const VotesIconAnimation: React.FC<VotesIconProps> = ({ height = '20px', color = '#59C134', animate = false }) => {
  return (
    <svg className={`rounded-full ${animate ? 'animation-pulse-vote' : ''}`} height={height} xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 512 512">
