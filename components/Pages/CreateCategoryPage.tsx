...
const CreateCategoryPage: React.FC<CreateCategoryPageProps> = ({ onNavigate, user }) => {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    let postData: any = {
      ...
      tags: categoryTags, // Include tags in the submission data
    };
    ...
    } else if (categoryType === 'HotSeat' || categoryType === 'MostLikely') {
      postData.questions = questions.map(q => q.question);
