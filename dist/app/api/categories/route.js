            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (typeof body.questionCount !== 'number' || body.questionCount < 0) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, message: 'Invalid question count' }, { status: 400 })];
                    }
                    return [4 /*yield*/, category_1.default.create(body)];
                case 2:
                    category = _a.sent();
                    // Return a successful response with the created category data
                    return [2 /*return*/, server_1.NextResponse.json({ success: true, data: category }, { status: 201 })];
                case 3:
                    error_1 = _a.sent();
                    console.error('Error creating category:', error_1);
                    // Return an error response with a status code 400
                    return [2 /*return*/, server_1.NextResponse.json({ success: false, message: 'Error creating category' }, { status: 400 })];
