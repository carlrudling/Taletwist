    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    body = _a.sent();
                    return [4 /*yield*/, subscription_1.default.create(body)];
                case 2:
                    subscription = _a.sent();
                    // Respond with the created subscription and a 201 status code
                    return [2 /*return*/, server_1.NextResponse.json({ success: true, data: subscription }, { status: 201 })];
                case 3:
                    error_1 = _a.sent();
                    console.error('Error creating subscription:', error_1);
                    // Respond with an error message and a 400 status code in case of failure
                    return [2 /*return*/, server_1.NextResponse.json({ success: false, message: 'Error creating subscription' }, { status: 400 })];
