        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ success: true, data: user }, { status: 200 })];
                case 3:
                    error_1 = _c.sent();
                    console.error('Error fetching user:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({ success: false, message: 'Error fetching user' }, { status: 400 })];
